...
from tests.helpers.support_functions import wait_for_visibility_of_element, wait_for_visibility_of_element_by_xpath
...
def form_add_proper_name(driver_instance):
    ...
    elem.send_keys(DataGenerator.generate_proper_name())


def form_add_wrong_name(driver_instance):
    elem = driver_instance.find_element_by_id(name)
    elem.send_keys(DataGenerator.generate_wrong_name(DataGenerator()))
...
def form_add_proper_phone(driver_instance):
    ...
    elem.send_keys(DataGenerator.generate_proper_mobile_number(DataGenerator()))
...
def form_add_proper_email(driver_instance):
    ...
    elem.send_keys(DataGenerator.generate_proper_email())
